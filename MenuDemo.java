...
public class MenuDemo implements ActionListener{
	...
	menuItem = new JMenuItem("Birthdate",
                                 KeyEvent.VK_M);
	...
	{
		Connection con=MyAccConnect.connection();
		try{
			Statement st=con.createStatement();
			 ResultSet r=st.executeQuery("select * from Birth");
			while(r.next()){
		String s=r.getString("Name")+" "+r.getString("Birthdate");			
